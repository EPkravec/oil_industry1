...
def run_server():
    ...
    #
    # slaves = {
    #     0xAB56: ModbusSlaveContext(''),
    #     # 0x2A: ModbusSlaveContext('c'),
    #     # 0x03: ModbusSlaveContext('h'),
    #     # 0x04: ModbusSlaveContext('i')
    # }
    ...
    # ----------------------------------------------------------------------- #
    store = ModbusSlaveContext(
        di=ModbusSequentialDataBlock(0xA1, [1]*100),
    ...
    StartSerialServer(context, framer=ModbusRtuFramer, identity=identity,
                      port='/dev/ttyUSB0', timeout=1.0, baudrate=9600,
